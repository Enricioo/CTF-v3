...
tellraw @a ["",{"text":"-AIRDROP lv.1- ","color":"gold"},{"text":"Coordinate: ["},{"score":{"name":"#board","objective":"x"}},{"text":", "},{"score":{"name":"#board","objective":"z"}},{"text":"]"}]
execute at @e[tag=airdrop] run place template minecraft:airdrop_materials ~ ~ ~
