...
execute positioned -688 67 -769 if score #board ZarbonTaken matches 1 as @a[distance=6..] run tag @s add zarbonDone
execute positioned -688 67 -769 if score #board ZarbonTaken matches 1 as @a[scores={ZarbonTalked=0},distance=..6,tag=zarbonDone] run tellraw @s {"text":"Zarbon: Ho già provveduto, non ho altro da darti!","color":"gold","bold":true}
execute positioned -688 67 -769 if score #board ZarbonTaken matches 1 as @a[scores={ZarbonTalked=0},distance=..6,tag=zarbonDone] run scoreboard players set @s ZarbonTalked 1
execute positioned -688 67 -769 if score #board ZarbonTaken matches 1 as @a[scores={ZarbonTalked=1},distance=6..,tag=zarbonDone] run scoreboard players set @s ZarbonTalked 0
...
execute positioned -586 116 -520 if score #board JuniorTaken matches 1 as @a[distance=6..] run tag @s add juniorDone
execute positioned -586 116 -520 if score #board JuniorTaken matches 1 as @a[scores={JuniorTalked=0},distance=..6,tag=juniorDone] run tellraw @s {"text":"Junior: Ho già provveduto, non ho altro da darti!","color":"gold","bold":true}
...
execute positioned -611 103 412 if score #board CrilinTaken matches 1 as @a[distance=6..] run tag @s add crilinDone
execute positioned -611 103 412 if score #board CrilinTaken matches 1 as @a[scores={CrilinTalked=0},distance=..6,tag=crilinDone] run tellraw @s {"text":"Crilin: Ho già provveduto, non ho altro da darti!","color":"gold","bold":true}
execute positioned -611 103 412 if score #board CrilinTaken matches 1 as @a[scores={CrilinTalked=0},distance=..6,tag=crilinDone] run scoreboard players set @s CrilinTalked 1
execute positioned -611 103 412 if score #board CrilinTaken matches 1 as @a[scores={CrilinTalked=1},distance=6..,tag=crilinDone] run scoreboard players set @s CrilinTalked 0
...
execute positioned -274 87 405 if score #board BeerusTaken matches 1 as @a[distance=6..] run tag @s add beerusDone
execute positioned -274 87 405 if score #board BeerusTaken matches 1 as @a[scores={BeerusTalked=0},distance=..6,tag=beerusDone] run tellraw @s {"text":"Beerus: Ho già provveduto, non ho altro da darti!","color":"gold","bold":true}
execute positioned -274 87 405 if score #board BeerusTaken matches 1 as @a[scores={BeerusTalked=0},distance=..6,tag=beerusDone] run scoreboard players set @s BeerusTalked 1
execute positioned -274 87 405 if score #board BeerusTaken matches 1 as @a[scores={BeerusTalked=1},distance=6..,tag=beerusDone] run scoreboard players set @s BeerusTalked 0
...
execute positioned -223 95 -527 if score #board MajinTaken matches 1 as @a[distance=6..] run tag @s add majinDone
execute positioned -223 95 -527 if score #board MajinTaken matches 1 as @a[scores={MajinTalked=0},distance=..6,tag=majinDone] run tellraw @s {"text":"Majin Bu: Ho già provveduto, non ho altro da darti!","color":"gold","bold":true}
execute positioned -223 95 -527 if score #board MajinTaken matches 1 as @a[scores={MajinTalked=0},distance=..6,tag=majinDone] run scoreboard players set @s MajinTalked 1
execute positioned -223 95 -527 if score #board MajinTaken matches 1 as @a[scores={MajinTalked=1},distance=6..,tag=majinDone] run scoreboard players set @s MajinTalked 0
...
execute positioned 389 88 -681 if score #board GohanTaken matches 1 as @a[distance=6..] run tag @s add gohanDone
execute positioned 389 88 -681 if score #board GohanTaken matches 1 as @a[scores={GohanTalked=0},distance=..6,tag=gohanDone] run tellraw @s {"text":"Gohan: Ho già provveduto, non ho altro da darti!","color":"gold","bold":true}
execute positioned 389 88 -681 if score #board GohanTaken matches 1 as @a[scores={GohanTalked=0},distance=..6,tag=gohanDone] run scoreboard players set @s GohanTalked 1
execute positioned 389 88 -681 if score #board GohanTaken matches 1 as @a[scores={GohanTalked=1},distance=6..,tag=gohanDone] run scoreboard players set @s GohanTalked 0
...
execute positioned 113 79 592 if score #board GokuTaken matches 1 as @a[distance=6..] run tag @s add gokuDone
