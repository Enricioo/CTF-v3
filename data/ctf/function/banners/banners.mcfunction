...
#Banner Team PINK
execute positioned 64 62 -612 if block ~ ~ ~ minecraft:pink_banner as @p[team=!pink,distance=..0.5] run function ctf:banners/take_pink
execute positioned 64 62 -612 as @p[team=pink,distance=..0.5] if items entity @s weapon.* minecraft:pink_banner run function ctf:banners/reset_pink

#Banner Team YELLOW
execute positioned 605 61 241 if block ~ ~ ~ minecraft:yellow_banner as @p[team=!yellow,distance=..0.5] run function ctf:banners/take_yellow
